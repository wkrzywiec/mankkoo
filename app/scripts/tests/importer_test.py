...
def test_load_pl_ing():
    ...
    # WHEN
    result = importer.load_bank_data(file_name=ing_file, contents=None, kind=models.Bank.PL_ING, account_id='iban-1')
...
def test_load_pl_mbank():
    ...
    # WHEN
    result = importer.load_bank_data(file_name=mbank_file, contents=None, kind=models.Bank.PL_MBANK, account_id='iban-1')
...
def test_load_pl_millenium():
    ...
    # WHEN
    result = importer.load_bank_data(file_name=millenium_file, contents=None, kind=models.Bank.PL_MILLENIUM, account_id='iban-1')
