...
interface WalletsDistributionSectionProps {
  pieData: PieChartData;
  tableData: TableData;
  isLoading: boolean;
}

const WalletsDistributionSection: React.FC<WalletsDistributionSectionProps> = ({ pieData, tableData, isLoading }) => (
...
export default WalletsDistributionSection;
